...
import { useGetPatientPrescriptionByIdQuery } from './prescription/prescriptionApiSlice';
...
const Prescriptions = () => {
  ...
  const { data: prescriptions, isLoading } = useGetPatientPrescriptionByIdQuery(localStorage.getItem('id'));
